...
void generate_keys(long *n, long *e, long *d) {
    // Two prime numbers (for simplicity, these are small primes)
...
// Function to encrypt the message using public key (n, e)
long encrypt(long message, long e, long n) {
    return mod_exp(message, e, n);
}

// Function to decrypt the message using private key (n, d)
